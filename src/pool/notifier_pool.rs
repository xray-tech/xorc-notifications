...
impl NotifierPool {
    ...
    fn create_new(&mut self, application_id: &str) {
        ...
        match self.certificate_registry.with_certificate(application_id, create_notifier) {
            ...
            Err(e) => {
                warn!("Couldn't find a certificate for application_id {}, reason: {:?}", application_id, e);
    ...
    fn update_expired(&mut self, application_id: &str) {
        ...
        match self.certificate_registry.with_certificate(&application_id, create_notifier) {
            ...
            Err(e) => {
                error!("Couldn't find a certificate for application_id {}, reason: {:?}", application_id, e);
